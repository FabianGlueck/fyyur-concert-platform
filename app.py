...
def venues():
  ...
  for venue in venues:
      ...
      num_upcoming_shows = len(venue.upcoming_shows) if venue.upcoming_shows else 0
...
def show_venue(venue_id):
  ...
  data.past_shows_count = len(data.past_shows) if data.past_shows else 0
  data.upcoming_shows_count = len(data.upcoming_shows) if data.past_shows else 0
